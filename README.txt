...
1. A shell script that takes input, creates a set of applications and components, creates a version and artifact for each component, then calls a Java program.
...
You can start several agents on a single host using Docker and stackinabox. For example:
